            ...
            <div class="bg-white rounded-lg shadow relative md:w-10/12 lg:w-9/12 mx-auto">
                ...
                <div class="p-6 space-y-6">
                    <div class="grid grid-cols-6 gap-6">
                        <div class="col-span-6 sm:col-span-3 relative">
                            ...
                            <div class="text-sm text-red-600 mt-1" v-if="errors['customer_id']">{{ errors['customer_id'][0] }}</div>
                        </div>
                        ...
                        <div class="col-span-6 sm:col-span-3">
                            ...
                            <div class="text-sm text-red-600 mt-1" v-if="errors['done']">{{ errors['done'][0] }}</div>
                        </div>
                ...
                <div class="items-center p-6 border-t border-gray-200 rounded-b">
                    <div class="flex items-center space-x-2">
                        <button @click="update" class="text-white bg-cyan-600 hover:bg-cyan-700 focus:ring-4 focus:ring-cyan-200 font-medium rounded-lg text-sm px-5 py-2.5 text-center" type="submit">Update Doctor</button>
                        <button @click="deleteData" class="text-white bg-red-600 hover:bg-red-700 focus:ring-4 focus:ring-red-200 font-medium rounded-lg text-sm px-5 py-2.5 text-center" type="submit">Delete Doctor</button>
                    </div>
                </div>
            </div>
